...
- `project_name`: the default docker compose project name (default: `nautobot_netbox_importer`)
...
#14 naming to docker.io/nautobot-netbox-importer/nautobot:latest-py3.7 done
```
...
ee90fbfabd77   nautobot-netbox-importer/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_netbox_importer_worker_1
b8adb781d013   nautobot-netbox-importer/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_netbox_importer_nautobot_1
d64ebd60675d   nautobot-netbox-importer/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_netbox_importer_docs_1
...
So for example, our plugin is named `nautobot-netbox-importer`, the command would most likely be `docker logs nautobot_netbox_importer_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
