...
class NetBoxDataSource(DataSource, Job):
    ...
    input_ref = StringVar(description="Input file reference (example: https://myhost/netbox_export.json)", default=None)
    ...
    def sync_data(self, memory_profiling):
        ...
        if memory_profiling:
            self.logger.warning("Memory profiling not implemented for NetBoxDataSource.")
