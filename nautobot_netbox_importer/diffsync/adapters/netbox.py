...
from nautobot_netbox_importer.diffsync.models.dcim import unrack_failing_devices
...
class NetBoxImporterOptions(NamedTuple):
    ...
    unrack_failing_devices: bool = True
...
class NetBoxAdapter(SourceAdapter):
    ...
    def load(self) -> None:
        ...
        if self.options.unrack_failing_devices:
            unrack_failing_devices(self)
        self.post_import()
